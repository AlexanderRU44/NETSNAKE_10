...
export class GameStateHandler {
    ...
    async handleMainMenu() {
        if (this.game.gameOver) {
            switch (this.game.mainMenuSelection) {
                ...
                case 2: this.game.currentScreen = "MULTIPLAYER"; this.game.updateMiniDisplay(); break;
            ...
            switch (this.game.mainMenuSelection) {
                ...
                case 3: this.game.currentScreen = "MULTIPLAYER"; this.game.updateMiniDisplay(); break;
    ...
    handleMultiplayerMenu() {
        if (this.game.multiplayerMenuSelection === 0) {
            this.game.startMultiplayerHost().then(roomId => {
                console.log("Room created:", roomId);
            });
        } else if (this.game.multiplayerMenuSelection === 1) {
            this.game.joinOverlay.style.display = "flex";
            this.game.currentScreen = "JOIN_MULTIPLAYER";
            setTimeout(() => this.game.roomCodeInput.focus(), 50);
        }
    }
