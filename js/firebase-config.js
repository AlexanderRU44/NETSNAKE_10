...
const firebaseConfig = {
    ...
    databaseURL: "https://retro-snake-94402-default-rtdb.europe-west1.firebasedatabase.app"
};

export const app = initializeApp(firebaseConfig);
export const db = getFirestore(app);
export const rtdb = getDatabase(app);
export { collection, addDoc, query, orderBy, limit, getDocs, where, ref, set, get, onValue, remove, update, push };
