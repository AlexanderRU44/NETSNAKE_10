    ...
    drawPixelMenu(title) {
        ...
        if (this.game.currentScreen === "MAIN") {
            ...
            if (this.game.gameOver) {
                options = [t.newGame, t.modesMenu, "MULTIPLAYER", t.modeInfoMenu, t.settings, t.records, t.tasksMenu, t.achievementsMenu, t.aboutMenu];
            } else {
                options = [t.continue, t.newGame, t.modesMenu, "MULTIPLAYER", t.modeInfoMenu, t.settings, t.records, t.tasksMenu, t.achievementsMenu, t.aboutMenu];
            }
